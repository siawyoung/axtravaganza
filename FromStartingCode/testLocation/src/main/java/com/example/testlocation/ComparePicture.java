...
public class ComparePicture extends ActionBarActivity {
	...
	static 
	{
		try
		{
            ...
            Log.d("CPP LIBRARY LOAD", "CPP LIBRARY LOADED ZOMG");
		}
 ...
 */
    ...
    // Added by Jiahao to test stuff
    public void testJniFunction(View view) {

        TextView testingTextView = (TextView)findViewById(R.id.testTextView);
